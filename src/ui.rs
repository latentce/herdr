...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        entry_is_folder_header, expanded_sidebar_sections, expanded_sidebar_toggle_rect,
        folder_header_chevron_rect, folder_view_workspace_ranks, is_top_level_drop_target,

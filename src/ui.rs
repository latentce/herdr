...
pub(crate) use self::{
    ...
    sidebar::{
        agent_entry_gap, agent_list_entry_height_in_body, agent_panel_body_rect,
        agent_panel_entries, agent_panel_list_entries, agent_panel_scroll_for_target,
        ...
        compute_workspace_card_areas, compute_workspace_group_header_areas,
        compute_workspace_list_areas, expanded_sidebar_sections, expanded_sidebar_toggle_rect,
        folder_ordered_workspace_ranks, normalized_workspace_scroll, sidebar_section_divider_rect,
        workspace_drop_slots, workspace_group_chevron_rect, workspace_list_entries,
        workspace_list_entries_expanded, workspace_list_entries_mobile, workspace_list_rect,
        workspace_list_scroll_metrics, workspace_list_scrollbar_rect, workspace_parent_group_state,
        AgentPanelClickTarget, AgentPanelEntry, AgentPanelListEntry, WorkspaceListEntry,
    },
};
...
pub fn render_with_runtime_registry(
    ...
    match app.mode {
        ...
        Mode::RenameWorkspace | Mode::RenameWorkspaceGroup | Mode::RenameTab | Mode::RenamePane => {
            render_rename_overlay(app, frame, frame.area())
        }
        Mode::WorkspaceGroupPicker => render_workspace_group_picker(app, frame),
...
mod tests {
    ...
    fn collapsed_sidebar_keeps_active_workspace_highlight_in_terminal_mode() {
        ...
        let (ws_area, _, _) =
            collapsed_sidebar_sections(app.view.sidebar_rect, app.agents_section_visible);

...
pub(crate) use self::{
    ...
    sidebar::{
        agent_panel_body_rect, agent_panel_entries, agent_panel_list_entries,
        agent_panel_row_for_entry, agent_panel_scroll_for_target, agent_panel_scroll_metrics,
        agent_panel_scrollbar_rect, agent_panel_toggle_rect, agent_row_gap,
        agent_row_height_in_body, all_agent_panel_entries, collapsed_sidebar_sections,
        collapsed_sidebar_toggle_rect, compute_workspace_card_areas, compute_workspace_list_areas,
        expanded_sidebar_sections, expanded_sidebar_toggle_rect, folder_header_chevron_rect,
        folder_view_workspace_ranks, is_top_level_drop_target, normalized_workspace_scroll,
